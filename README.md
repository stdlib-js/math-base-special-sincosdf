...
```javascript
import sincosdf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-sincosdf@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-sincosdf@deno/mod.js';
```
...
[@stdlib/math/base/special/cosdf]: https://github.com/stdlib-js/math-base-special-cosdf/tree/deno

[@stdlib/math/base/special/sindf]: https://github.com/stdlib-js/math-base-special-sindf/tree/deno
