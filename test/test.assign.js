...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof sincosdf, 'function', 'main export is a function' );
	t.end();
} );
...
tape( 'the function supports providing an output typed array', function test( t ) {
	...
	parts = sincosdf( 1.0, out, 1, 0 );

	t.strictEqual( parts, out, 'returns output array' );
	t.strictEqual( parts[ 0 ], 0.017452405765652657, 'has expected first element' );
	t.strictEqual( parts[ 1 ], 0.9998477101325989, 'has expected second element' );
...
tape( 'the function supports specifying a stride', function test( t ) {
	...
	val = sincosdf( 1.0, out, 2, 0 );

	t.strictEqual( val, out, 'returns output array' );
	t.strictEqual( val[ 0 ], 0.017452405765652657, 'returns expected value' );
	t.strictEqual( val[ 1 ], 0, 'returns expected value' );
	t.strictEqual( val[ 2 ], 0.9998477101325989, 'returns expected value' );
...
tape( 'the function supports specifying an offset', function test( t ) {
	...
	out = new Float32Array( 4 );
	val = sincosdf( 1.0, out, 2, 1 );

	t.strictEqual( val, out, 'returns output array' );
	t.strictEqual( val[ 0 ], 0, 'returns expected value' );
	t.strictEqual( val[ 1 ], 0.017452405765652657, 'returns expected value' );
	t.strictEqual( val[ 2 ], 0, 'returns expected value' );
	t.strictEqual( val[ 3 ], 0.9998477101325989, 'returns expected value' );
